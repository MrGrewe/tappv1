  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#18544b]">
      ...
      <div className="hidden md:flex w-1/2 h-screen relative items-center justify-center">
        ...
        />
        <div className="relative z-10 p-12 text-white flex flex-col h-full justify-end bg-gradient-to-t from-black/60 via-black/20 to-transparent">
          <h1 className="text-4xl font-extrabold mb-4 drop-shadow-lg">Welcome back!</h1>
          <p className="mb-8 text-lg font-medium drop-shadow">Log in to your account to manage your bookings, preferences, and more.</p>
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white min-h-screen py-8 px-4">
        <form onSubmit={handleAuth} className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-gray-100 flex flex-col gap-6">
          <h2 className="text-2xl font-extrabold text-gray-900 text-center mb-2">Login Now!</h2>
          <p className="text-center text-gray-500 mb-2">Welcome back! Please enter your details.</p>
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-sm text-blue-700 font-semibold hover:underline">Forgot password?</a>
          </div>
          <button
            type="submit"
          ...
          <div className="text-center text-gray-500 text-sm mt-2">
            {isSignup ? (
              <>
                ...
                <button type="button" className="text-blue-700 font-semibold hover:underline" onClick={() => setIsSignup(false)}>Log In</button>
              </>
            ) : (
              <>
                Don&apos;t have an account?{' '}
                <button type="button" className="text-blue-700 font-semibold hover:underline" onClick={() => setIsSignup(true)}>Sign Up</button>
              </>
            )}
          </div>
          ...
          <div className="flex gap-3 justify-center">
            <button type="button" className="border border-gray-200 rounded-lg p-3 hover:bg-gray-50 transition flex items-center justify-center">
