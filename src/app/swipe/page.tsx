...
export default function SwipePage() {
  ...
  if (done) {
    return <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center bg-gradient-to-b from-gray-100 to-gray-200 text-lg font-semibold text-gray-600">Keine weiteren Profile verfügbar.<br />Komm später wieder!</div>;
  }
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 px-4">
      <div className="w-full max-w-md">
        ...
        >
          <div className="bg-white/90 rounded-2xl shadow-2xl p-8 flex flex-col items-center border border-gray-100">
